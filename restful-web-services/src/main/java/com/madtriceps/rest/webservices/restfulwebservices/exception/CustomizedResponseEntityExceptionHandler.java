package com.madtriceps.rest.webservices.restfulwebservices.exception;
...
import com.madtriceps.rest.webservices.restfulwebservices.user.UserNotFoundException;
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		StringBuilder errorMessage = new StringBuilder();
	        ...
	        for (ObjectError objectError : ex.getBindingResult().getAllErrors()) {
	            errorMessage.append("Error No.").append(++errorCount).append(": ").append(objectError.getDefaultMessage());
	        }
